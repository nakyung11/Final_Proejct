...
# If you don't want your environment to be cluttered by having the same data in there twice under two names, you can do that in one step when you import OR I learned you can delete from the environment by using rm(name_of_thing_you_dont_want_anymore) -Suzie
```
...
## Wow! A lot of great code here! I haven't done the list of demo variables before. Maybe consider changeing the colors in the plot to demonstrate that skill? -Suzie
...
##This table is HUGE. I would consider making smaller tables. There's too much information in the table for a reader to digest! OR add a table of contents option in your YAML so you can skip to the next thing without having to scroll forever. -Suzie
```
...
## I've never thought about different ways to measure social media engagement--so cool to see watching, interacting, and sharing. I bet there were some interesting discussions in your group to decide how to recode. Also, it makes me think about how one would measure "lurking" on social media (looking but not liking or sharing). -Suzie 
```
...
## I love the way this plot looks, but the stacking bars make it harder to compare the yes and no telehealth users. -Suzie
...
## Nevermind!! I see you did it both ways! Major kudos for all that work! -Suzie
...
## I would rename the SM_Usage_Frequency to something like "Social Media Usage Frequency."
